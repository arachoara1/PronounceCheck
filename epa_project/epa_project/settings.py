...
# 각 버킷의 기본 도메인 설정
AWS_S3_CUSTOM_DOMAIN_USER = (
    f"{AWS_STORAGE_BUCKET_NAME_USER}.s3.{AWS_S3_REGION_NAME}.amazonaws.com"
)
AWS_S3_CUSTOM_DOMAIN_STANDARD = (
    f"{AWS_STORAGE_BUCKET_NAME_STANDARD}.s3.{AWS_S3_REGION_NAME}.amazonaws.com"
)
